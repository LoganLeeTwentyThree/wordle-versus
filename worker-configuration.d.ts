/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 37e788b24db189e41fed51275fd6a2ee)
// Runtime types generated with workerd@1.20260430.1 2026-05-03 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "WordleVs" | "Matchmaker";
	}
	interface Env {
		ASSETS: Fetcher;
		WORDLE_VS: DurableObjectNamespace<import("./worker/index").WordleVs>;
		MATCHMAKER: DurableObjectNamespace<import("./worker/index").Matchmaker>;
	}
}
